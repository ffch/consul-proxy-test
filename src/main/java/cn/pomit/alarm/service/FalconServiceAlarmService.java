...
public class FalconServiceAlarmService implements AlarmService {
	...
	public FalconServiceAlarmService(String falconAlarmBase, String falconAlarmServices, String falconAlarmToken,
	...
	public ResultModel getAlarmInfo(Integer range) throws IOException {
		...
		String urlStr = falconAlarmBase + URLUtil.completePath(falconAlarmServices);
		...
		Request request = new Request.Builder().url(urlBuilder.build())
				.addHeader("cookie", "SESSION=" + falconAlarmToken).build();
